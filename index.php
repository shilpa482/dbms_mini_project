                ...
                <div class="row">
                    <div class="col-xl-7 pa-0">
                        <div id="owl_demo_1" class="owl-carousel dots-on-item owl-theme">
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url(dist/img/OIP.jfif);">
                            ...
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url(dist/img/dairy.jfif);">
                                <div class="auth-cover-info py-xl-0 pt-100 pb-50">
                                    <div class="auth-cover-content text-center w-xxl-75 w-sm-90 w-xs-100">
