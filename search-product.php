...
//code for adding product in cart
    case "add":
        if(!empty($_POST["quantity"])) {
            ...
            $itemArray = array($productByCode["id"]=>array( 'compname'=>$productByCode["CompanyName"], 'quantity'=>$_POST["quantity"], 'pname'=>$productByCode["ProductName"], 'price'=>$productByCode["ProductPrice"],'code'=>$productByCode["id"]));
